...
class HotelOffers(models.Model):
    ...
    date_begin = models.DateTimeField(verbose_name='дата_заезда', blank=False)
    date_end = models.DateTimeField(verbose_name='дата_выезда', blank=False)
    ...
    cancellation_info = JSONField(verbose_name='штраф_за_отмену_бронирования', default=dict())
