...
class HotelOffers(models.Model):
    ...
    m_offer_id = models.CharField(verbose_name='ID_предложения', max_length=25, unique=True, blank=False)
    ...
    is_cancelled = models.BooleanField(verbose_name='отмено_бронирование?', default=True, blank=False)
